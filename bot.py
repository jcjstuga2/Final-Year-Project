...
class TradingBot():
    #create the 3 logs, loads the settings (the pairs and ma to use), starts the API connection, and display the starting messages on the logs.
    def __init__(self):    
        ...
        self.api = OandaAPI()
        self.status_code = self.api.testcode()        
